...
public partial class Views : System.Web.UI.Page
{
    ...
    protected void txttimkiem_Click(object sender, EventArgs e)
    {
        ...
        // Kiểm tra và lấy giá trị từ các TextBox
        string sensorID = txtIDThongtin.Text;
        string thoigiantruoc = txttimestart.Text;
        string thoigiansau = txttimeend.Text;
        ...
        SqlDataSource1.SelectCommand = "SELECT * FROM data WHERE IDThongtin = @sensorid " +
