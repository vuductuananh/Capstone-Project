<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Truyxuat.aspx.cs" Inherits="Views" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Truy xuất</title>
...
<div class="w3-main" style="margin-left:100px;margin-right:100px;margin-top:43px;">
  ...
  <div class="w3-container">
    ...
    <h3 class="fa fa-bell">&nbsp;<b> Nhập thông tin muốn tìm</b></h3>

      <p style="text-align:center">
          <asp:TextBox ID="txtIDThongtin" runat="server" placeholder="Nhập ID Thông tin..." BorderStyle="Outset"></asp:TextBox>
          <asp:TextBox ID="txttimestart" runat="server" placeholder="Thời gian bắt đầu..." BorderStyle="Outset"></asp:TextBox>
          <asp:TextBox ID="txttimeend" runat="server" placeholder="Thời gian kết thúc..." BorderStyle="Outset"></asp:TextBox>
          <asp:Button ID="txttimkiem" runat="server" OnClick="txttimkiem_Click" Text="Tìm kiếm" BackColor="white" BorderStyle="Outset" Font-Bold="True" style="border-radius: 5px; font-style: italic"/>
      </p>
      <p>
          ...
          <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConStr %>" SelectCommand="SELECT * FROM data WHERE SensorID = @sensorid AND Thoigian BETWEEN @timestart AND @timeend">
              <SelectParameters>
                  <asp:ControlParameter ControlID="txtsensorID" Name="sensorid" PropertyName="Text" Type="String" />
                  <asp:ControlParameter ControlID="txttimestart" Name="timestart" PropertyName="Text" Type="DateTime" />
                  <asp:ControlParameter ControlID="txttimeend" Name="timeend" PropertyName="Text" Type="DateTime" />
              </SelectParameters>
          </asp:SqlDataSource>--%>

         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConStr %>" SelectCommand="SELECT * FROM data WHERE IDThongtin = @sensorid AND Thoigian > CONVERT(datetime, @timestart, 103) AND Thoigian < CONVERT(datetime, @timeend, 103) ORDER BY Thoigian DESC">
         <SelectParameters>
            <asp:ControlParameter ControlID="txtIDThongtin" Name="sensorid" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txttimestart" Name="timestart" PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="txttimeend" Name="timeend" PropertyName="Text" Type="String" />
         </SelectParameters>
         </asp:SqlDataSource>
